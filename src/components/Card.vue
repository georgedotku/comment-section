<template>
  <div class="bg-white p-4 w-1/2 h-50 relative rounded-lg shadow-md">
    <div
    ...
    <div
      className="group flex mx-10 absolute top-4 left-4 w-[90%] items-center border gap-2 sm:flex-row sm:gap-4">
      <img
